...
namespace RexStudios.PluginDevelopment
{
    public static partial class Constants
    {
        ...
        public static class Messages
        {
            ...
            public const string PCPWEBREQUESTACTION = "rex_webrequestaction";

        }

        public static class Reservations
        {
            public const string LOGICALNAME = "rex_Reservation";

            public static class ExceptionMessages
            {
                public const string UPDATEOPERATION = "Update Operation is not allowed in VersionControl Entity";
            }
        }
    }
}
