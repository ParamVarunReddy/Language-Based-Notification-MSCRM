...
namespace RexStudios.PluginDevelopment
{
    ...
    public abstract class PluginBase : IPlugin
    {
        ...
        public class LocalPluginContext
        {
            ...
            /// <summary>
            /// This Property is under the User entity as Custom field for language, which is also an 
            /// custom entity that holds the language settins like code, culture and country
            /// </summary>
            public int CustomUserLanguage { get; private set; }
            public int UserLanguagePreferences { get; private set; }
            ...
            public LocalPluginContext(IServiceProvider serviceProvider)
            {
                ...
                UserServices = new UserService(OrganizationService, TracingService);

                ServiceContext = new ServiceContext(OrganizationService);

                CustomUserLanguage = UserServices.GetUserLanguageFromUser(PluginExecutionContext.UserId);
                UserLanguagePreferences = UserServices.GetUserLanguageFromUserPreferences(PluginExecutionContext.UserId);
            }
